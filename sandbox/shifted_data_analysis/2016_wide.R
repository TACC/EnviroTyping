...
setwd("\$WORK/GitHub/EnviroTyping/sandbox/shifted_data_analysis/output")
df.16 <- read_rds("../../../data/interim/2016/hyb_by_mon_calib_wide.rds")


variance.var <- names(which(map_dbl(df.16[,17:415], var, na.rm = TRUE) != 0))
