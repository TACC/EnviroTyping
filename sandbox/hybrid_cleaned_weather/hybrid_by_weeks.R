...
write_csv(hybrid, "data/interim/G2F_Hybrid/hybrid_by_week_cleaned_weather.csv")

write_rds(hybrid, "data/interim/G2F_Hybrid/hybrid_by_week_cleaned_weather.Rds", compress = "xz", compression = 1L)

check <- read_rds("data/interim/G2F_Hybrid/hybrid_by_week_cleaned_weather.Rds")
